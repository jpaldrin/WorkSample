...
namespace AldrinWorkSample.App_Start
{
    ...
    public class ApplicationUserManager : UserManager<Model.IdentityModels.ApplicationUser>
    {
        public ApplicationUserManager(IUserStore<Model.IdentityModels.ApplicationUser> store)
           : base(store)
        {
        }
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Model.IdentityModels.ApplicationUser>(context.Get<AldrinWorkSampleDbContext>()));
            // Configure validation logic for usernames
            manager.UserValidator = new UserValidator<Model.IdentityModels.ApplicationUser>(manager)
            {
